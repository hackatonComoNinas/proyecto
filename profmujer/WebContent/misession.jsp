...
String miusuario= ""+ sesionOk.getAttribute("id");
String nombre= ""+ sesionOk.getAttribute("nom");

if(miusuario==null||nombre==null){
...
<link rel="stylesheet" href="../profmujer/bootstrap/css/sb-admin.min.css" type="text/css">

    <!-- Bootstrap core CSS -->
    <link href="vendor/bootstrap/css/bootstrap.min.css" rel="stylesheet">

    <!-- Custom fonts for this template -->
    <link href="../profmujer/vendor/font-awesome/css/font-awesome.min.css" rel="stylesheet" type="text/css">

    <!-- Plugin CSS -->
    <link href="../profmujer/vendor/datatables/dataTables.bootstrap4.css" rel="stylesheet">

    <!-- Custom styles for this template -->
    <link href="../profmujer/bootstrap/css/sb-admin.min.css" rel="stylesheet">
</head>
<body id="page-top">
    ...
    <nav id="mainNav" class="navbar static-top navbar-toggleable-md navbar-inverse bg-inverse">
        ...
        <a class="navbar-brand" href="#">Bienvenida: <%out.println(""+nombre); %></a>
        <div class="collapse navbar-collapse" id="navbarExample">
            <ul class="sidebar-nav navbar-nav">
                <li class="nav-item active">
                    <a class="nav-link" href="#message"><i class="fa fa-fw fa-dashboard"></i> Principal</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#contactos"><i class="fa fa-fw fa-area-chart"></i> Contactos</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#citas"><i class="fa fa-fw fa-table"></i> Citas</a>
                </li>
                   		 ...
                   		 <jsp:forwardpage="login.jsp"> 
                   		  ...
                   		  else
                   		  {
                   	        ...
                   	        try{
                   	    		...
                   	    		String sql="select mismensajes.contactoid,mismensajes.fechamsg, mismensajes.descrimsg, contactos.contacto_nom from mismensajes, contactos where mismensajes.miusuario='"+miusuario+"' and  mismensajes.contactoid=contactos.contactoid";
                   	    		//out.println(sql);
                   	    		String fechamsg="";
                   	    		String descimsg="";
                   	    		...
                   	    		%>
            						<ul class="navbar-nav ml-auto">
                    						...
                    						<%
                    						out.println("<i class=\"fa fa-fw fa-envelope\"></i> <span class=\"hidden-lg-up\">Mensajes <span class=\"badge badge-pill badge-primary\">"+count+" Nuevos </span></span>");
                    						out.println("<span class=\"new-indicator text-primary hidden-md-down\"><i class=\"fa fa-fw fa-circle\"></i><span class=\"number\">"+count+"</span></span>");
                    						%>
                ...
                <%    	    		
                   	    			 while(rs.next()){
                   	    				 ...
                   	    				 if(rs.wasNull()){
                   	    				 		...
                   	    				 		fechamsg=rs.getString("fechamsg");
                               	    			descimsg=rs.getString("descrimsg");
                               	    			nombrecontacto=rs.getString("contacto_nom");
                               	    			contactoid=rs.getInt("contactoid");
                               	    		 	out.println("<a class=\"dropdown-item\" href=\"#message\">");
                               	    			out.println("<strong>"+nombrecontacto+"</strong> <span class=\"small float-right text-muted\">"+fechamsg+"</span>");
                               	    			out.println("<div class=\"dropdown-message small\">"+descimsg+"</div>");
                               	    			out.println("</a>");
	          ...
	          out.println("<p>Error al acceder a la base de datos</p>"+e);
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle mr-lg-2" href="#" id="alertsDropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <i class="fa fa-fw fa-bell"></i> <span class="hidden-lg-up">Alertas <span class="badge badge-pill badge-warning">6 Nuevos</span></span>
    ...
    <div class="content-wrapper py-3">
        ...
        <div class="container-fluid">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Mi sesi&oacute;n</li>
            </ol>
            ...
            <!-- Area Chart Example -->
            <div class="card mb-3"  id="message" role="tabpanel">
...
<div class="row">
            ...
            <!-- Example Tables Card -->
                <div class="card-header" id="citas">
 ...
 -->
    ...
    <script src="../profmujer/vendor/jquery/jquery.min.js"></script>
    <script src="../profmujer/vendor/tether/tether.min.js"></script>
    <script src="../profmujer/vendor/bootstrap/js/bootstrap.min.js"></script>

    <!-- Plugin JavaScript -->
    <script src="../profmujer/vendor/jquery-easing/jquery.easing.min.js"></script>
    <script src="../profmujer/vendor/chart.js/Chart.min.js"></script>
    <script src="../profmujer/vendor/datatables/jquery.dataTables.js"></script>
    <script src="../profmujer/vendor/datatables/dataTables.bootstrap4.js"></script>
